...
3. If it crashes, click the **Share Log** button in the log viewer or screenshot the log.
4. [Submit a new Issue](https://github.com/Coder787-source/KytyPlus/issues) and paste the log(or add the screenshot).
