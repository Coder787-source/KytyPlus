...
public:
    ...
    bool CreateGTAVPipeline(vk::Pipeline& pipeline, vk::PipelineLayout layout);
    void TraceRays(
    ...
    std::vector<uint8_t> GetShaderGroupHandles(vk::Pipeline pipeline, uint32_t firstGroup, uint32_t groupCount);
